...
const Footer = () => {
	return (
		<div className=' bg-gray-900 text-white  p-14'>
			<footer className='footer pb-14 border-b'>
			...
			<div className='flex flex-wrap justify-between mt-12 text-xs'>
				<p>@2023 HireMe. All Rights Reserved</p>
				<p>Powered by HireMe</p>
			</div>
		</div>
	);
};
